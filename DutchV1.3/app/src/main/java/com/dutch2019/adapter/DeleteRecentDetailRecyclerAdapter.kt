...
import com.dutch2019.databinding.ItemDeleteRecentDetailBinding
...
class DeleteRecentDetailRecyclerAdapter :  RecyclerView.Adapter<DeleteRecentDetailRecyclerAdapter.DeleteRecentDetailViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DeleteRecentDetailViewHolder {
        val binding =
            ItemDeleteRecentDetailBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    class DeleteRecentDetailViewHolder(private val binding: ItemDeleteRecentDetailBinding) :
